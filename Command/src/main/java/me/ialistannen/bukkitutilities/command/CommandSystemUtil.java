...
import me.ialistannen.bukkitutilities.reflection.ReflectionUtil.ExecutablePredicate;
import me.ialistannen.bukkitutilities.reflection.ReflectionUtil.MemberPredicate;
    ...
    private static boolean printError(ReflectResponse<?> response, String message) {
        if (!response.isValuePresent()) {
            if (response.getException() != null) {
                BukkitUtilities.getInstance().getLogger().log(Level.WARNING,
