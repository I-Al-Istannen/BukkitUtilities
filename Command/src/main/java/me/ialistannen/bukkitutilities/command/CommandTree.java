...
import me.ialistannen.bukkitutilities.utilities.disable.DisableListener;
...
public class CommandTree {
     ...
     * <p>
     * Uses {@link BukkitUtilities}s DisableManager
     *
     * @see #CommandTree(DisableManager)
     */
    @SuppressWarnings("unused")
    public CommandTree() {
        this(BukkitUtilities.getInstance().getDisableManager());
    }
     ...
     */
    @SuppressWarnings("unused")
    public void addTopLevelChildAndRegister(CommandNode node, CommandExecutor executor, TabCompleter tabCompleter,
                                            Plugin owner, String... aliases) {
        root.addChild(node);
