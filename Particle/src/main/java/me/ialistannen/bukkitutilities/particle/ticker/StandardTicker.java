package me.ialistannen.bukkitutilities.particle.ticker;
...
public enum StandardTicker {
    ...
    BUKKIT_SYNC_RUNNABLE(() -> new BukkitRunnableTicker(5) {
        ...
        protected void startRunnable(long ticksDelay) {
            runnable.runTaskTimer(BukkitUtilities.getInstance(), 0, ticksDelay);
        }
    }),
    /**
    ...
    ASYNC_BUKKIT_RUNNABLE(() -> new BukkitRunnableTicker(5) {
        @Override
        protected void startRunnable(long ticksDelay) {
            runnable.runTaskTimerAsynchronously(BukkitUtilities.getInstance(), 0, ticksDelay);
        }
    }),
    /**
