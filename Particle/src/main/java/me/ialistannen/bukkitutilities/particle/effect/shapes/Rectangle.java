package me.ialistannen.bukkitutilities.particle.effect.shapes;
...
public class Rectangle extends AbstractParticleShape {
    ...
    public Rectangle(Orientation orientation, double sideLength, double granularity, Particle particle, boolean
            filled) {
