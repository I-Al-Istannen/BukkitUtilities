package me.ialistannen.bukkitutilities.utilities.item;
...
public class ItemFactory implements Cloneable {
    ...
    private static Set<Material> COLORABLE = EnumSet.of(Material.STAINED_CLAY,
    ...
    @SuppressWarnings("unused")
    @Nonnull
    public ItemFactory setColor(@Nonnull DisplayColor colour) {
    ...
    @SuppressWarnings("unused")
    @Nonnull
    public ItemFactory setArmourColor(@Nonnull Color colour) {
        Objects.requireNonNull(colour, "colour can not be null");
