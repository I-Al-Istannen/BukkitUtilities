...
import me.ialistannen.bukkitutilities.packet.PacketManager;
import me.ialistannen.bukkitutilities.reflection.ReflectionUtil;
import me.ialistannen.bukkitutilities.reflection.ReflectionUtil.FieldPredicate;
...
public class AnvilGui extends Gui implements AnvilInputHolder {
    ...
    public AnvilGui(String name, Consumer<Optional<String>> callback) {
        ...
        setItem(AnvilClickEvent.AnvilSlot.INPUT_LEFT,
    ...
    public void setItem(AnvilClickEvent.AnvilSlot slot, ItemStack itemStack, @SuppressWarnings("SameParameterValue") 
            boolean movable) {
