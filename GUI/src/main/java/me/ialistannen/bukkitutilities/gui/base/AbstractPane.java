...
public abstract class AbstractPane extends AbstractComponent implements Pane {
    ...
    public AbstractPane(int width, int height, InventoryMap inventoryMap) {
        ...
        if (!inventoryMap.getSize().equals(getSize())) {
            throw new IllegalArgumentException("InventoryMap has wrong size. Expected " + getSize() + " got " +
                    inventoryMap
                            .getSize());
        }
    ...
    protected static class Interval implements Cloneable {
         ...
         */
        @SuppressWarnings("WeakerAccess")   // subclasses. If you can see it, you might need it
    ...
    public static class InventoryMap implements Cloneable {
        ...
        @SuppressWarnings("WeakerAccess")   // allow subclasses to clear it or do similar things
         ...
         *
         * @throws IllegalArgumentException if
         *                                  {@code minX/maxX < 0 or minY/maxY < 0 or minX/maxX > width or minY/maxY >
         *                                  height
         ...
         */
        @SuppressWarnings("WeakerAccess")
        protected void fillInterval(Interval interval, @SuppressWarnings("SameParameterValue") boolean value) {
